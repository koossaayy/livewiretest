...
>
    ...
    <div x-data="{ orderName: '', quantity: 0 }" class="space-y-2 mt-6">
        ...
        <button @click="alert('{{ __('Order #') }}' + selectedOrder + ' has been flagged for review')">
            Flag for Review
        </button>
    </div>
    ...
    <div class="mt-8 bg-gray-50 rounded-xl p-6">
        ...
        <p class="text-sm text-gray-600 mb-4">
            {{ __('Last sync: :param_1 &nbsp;&bull;&nbsp; Next sync in 15 minutes', ['param_1' => now()->format('M d, Y \a\t g:i A')]) }}
        </p>

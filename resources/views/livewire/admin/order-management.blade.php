                            ...
                            <div class="flex items-center justify-end gap-2">
                                @if ($order->status === 'processing')
                                    <button
                                        ...
                                        wire:confirm="{{ __('Mark this order as shipped? The customer will receive a notification email.') }}"
                                ...
                                @if ($order->status !== 'cancelled' && $order->status !== 'refunded')
                                    <button
                                        ...
                                        wire:confirm.prompt="{{ __('Type CANCEL to cancel this order. The customer will be refunded and notified automatically.') }}|CANCEL"

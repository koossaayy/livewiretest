...
class ProfileForm extends Component
{
    ...
    public function saveProfile(): void
    {
        ...
        try {
            ...
            $this->successMessage = __('Your profile has been updated successfully.');
            session()->flash('success', __('Profile saved!'));
        } catch (\Exception $e) {
            Log::error('Profile update failed', ['user_id' => Auth::id(), 'error' => $e->getMessage()]);

            $this->errorMessage = __('We could not save your changes. Please try again.');
            session()->flash('error', __('Something went wrong while saving your profile.'));
        }
    }
    ...
    public function deleteAvatar(): void
    {
        ...
        if ($user->avatar_path) {
            ...
            $this->successMessage = __('Profile photo removed.');
        } else {
            $this->errorMessage = __('No profile photo to remove.');
        }
    }
    ...
    public function resendVerification(): void
    {
        ...
        if ($user->hasVerifiedEmail()) {
            $this->errorMessage = __('Your email is already verified.');
            return;
        }
        ...
        $this->successMessage = __('Verification email sent! Check your inbox.');
        session()->flash('success', __('A verification link has been sent to your email address.'));
    }
    ...
    public function deactivateAccount(): void
    {
        ...
        session()->flash('info', __('Your account has been deactivated.'));

...
class OrderManagement extends Component
{
    ...
    {
        session()->flash('success', __(':count orders are being exported.', ['count' => count($orderIds)]));
    }
    ...
    {
        session()->flash('success', __(':count orders have been archived.', ['count' => count($orderIds)]));
    }
    ...
    {
        session()->flash('success', __('Store credit of $:number_format has been issued.', ['number_format' => number_format($amount, 2)]));
    }
